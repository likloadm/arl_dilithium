from arl_dilithium import generate_keypair, sign, verify, priv_to_pub, generate_keypair_random
import binascii
import hashlib
import time
...
key = hashlib.pbkdf2_hmac('sha512', passwd, salt, iterations=500000, dklen=32)
